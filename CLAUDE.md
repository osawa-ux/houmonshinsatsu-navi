...
詳細（secrets 探索順序）: `docs/runbooks/secrets-lookup.md`
...
詳細（pre-commit hook 動作仕様・過去の誤動作パターン debug・CI workflow trigger 一覧）: `docs/runbooks/pre-commit-hook-operations.md`
...
詳細（Obsidian 連携詳細・能力カタログ連携汎用版・Obsidian 保存方針・報告形式・MEMORY.md 運用）: `docs/design/obsidian-integration-details.md`
